...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("render_status",
                  postgresql.ENUM(name="proposal_render_status", create_type=False),
                  server_default=sa.text("'pending'"), nullable=False),
        sa.Column("render_error", sa.Text, nullable=True),
        sa.Column("status",
                  postgresql.ENUM(name="proposal_status", create_type=False),
    ...
    op.create_table(
        ...
        sa.Column("status",
                  postgresql.ENUM(name="parcela_payment_status", create_type=False),
                  server_default=sa.text("'pending'"), nullable=False),
